...
from .views import ContentView, ContentDetailView, LanguageView, ContentLanguageDetailView, ContentVersionView
...
urlpatterns = [
    ...
    path('contents/<int:content_id>/versions', ContentVersionView.as_view(), name='content_versions'),
